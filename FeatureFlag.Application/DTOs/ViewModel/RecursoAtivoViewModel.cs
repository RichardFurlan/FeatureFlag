...
public record RecursoAtivoViewModel
{
    public RecursoAtivoViewModel(string identificacaoRecurso, string descricaoRecurso ,string identificacaoConsumidor, bool ativo)
    {
